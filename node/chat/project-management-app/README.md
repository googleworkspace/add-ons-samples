...
which responds to
[interaction events](https://developers.google.com/workspace/add-ons/chat/build#event-objects)
from Google Chat.
...
[dedicated tutorial](https://developers.google.com/add-ons/samples/tutorial-project-management)
