...
describe('HelpCard', function () {
  it('should return Help card', function () {
    const expected = Object.assign(Object.create(HelpCard.prototype), {
      header: {
