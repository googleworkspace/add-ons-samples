...
function onMessage(event) {
  ...
  const messageId = `client-${Utilities.getUuid()}`;
  createMessage(requestAgent("You can select from the following options", messageId, chatEvent.messagePayload.message.text), messageId)
...
function createMessage(message, messageId) {
