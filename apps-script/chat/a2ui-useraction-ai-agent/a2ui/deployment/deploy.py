...
"""Deployment script for A2UI AI Agent with user action."""
...
def create() -> None:
    """Creates an agent engine for  A2UI AI Agent with user action."""
...
def update(resource_id: str) -> None:
    """Updates an agent engine for  A2UI AI Agent with user action."""
    adk_app = AdkApp(agent=root_agent, enable_tracing=True)
