# Google Chat Incident Response app with user auth
...
[dedicated tutorial](https://developers.google.com/workspace/add-ons/samples/tutorial-incident-response-user-auth)
